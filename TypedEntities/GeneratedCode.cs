...
namespace TypedEntities
{
	...
	public partial class Contact : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		/// 
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("dir_badgeid")]
		public string dir_badgeid
		{
			get
			{
				return this.GetAttributeValue<string>("dir_badgeid");
			}
			set
			{
				this.OnPropertyChanging("dir_badgeid");
				this.SetAttributeValue("dir_badgeid", value);
				this.OnPropertyChanged("dir_badgeid");
			}
		}
		...
		public System.Nullable<TypedEntities.ContactState> StateCode
		{
			get
			{
				...
				if ((optionSet != null))
				{
					return ((TypedEntities.ContactState)(System.Enum.ToObject(typeof(TypedEntities.ContactState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<TypedEntities.Contact> Referencedcontact_customer_contacts
		{
			get
			{
				return this.GetRelatedEntities<TypedEntities.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.OnPropertyChanging("Referencedcontact_customer_contacts");
				this.SetRelatedEntities<TypedEntities.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
		...
		public System.Collections.Generic.IEnumerable<TypedEntities.Contact> Referencedcontact_master_contact
		{
			get
			{
				return this.GetRelatedEntities<TypedEntities.Contact>("contact_master_contact", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.OnPropertyChanging("Referencedcontact_master_contact");
				this.SetRelatedEntities<TypedEntities.Contact>("contact_master_contact", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
				this.OnPropertyChanged("Referencedcontact_master_contact");
			}
		}
		
		/// <summary>
		/// 1:N dir_contact_dir_vote
		/// </summary>
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("dir_contact_dir_vote")]
		public System.Collections.Generic.IEnumerable<TypedEntities.dir_vote> dir_contact_dir_vote
		{
			get
			{
				return this.GetRelatedEntities<TypedEntities.dir_vote>("dir_contact_dir_vote", null);
			}
			set
			{
				this.OnPropertyChanging("dir_contact_dir_vote");
				this.SetRelatedEntities<TypedEntities.dir_vote>("dir_contact_dir_vote", null, value);
				this.OnPropertyChanged("dir_contact_dir_vote");
			}
		}
		...
		public TypedEntities.Contact Referencingcontact_customer_contacts
		{
			get
			{
				return this.GetRelatedEntity<TypedEntities.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
			set
			{
				this.OnPropertyChanging("Referencingcontact_customer_contacts");
				this.SetRelatedEntity<TypedEntities.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referencing, value);
		...
		public TypedEntities.Contact Referencingcontact_master_contact
		{
			get
			{
	...
	[System.Runtime.Serialization.DataContractAttribute()]
	[System.CodeDom.Compiler.GeneratedCodeAttribute("CrmSvcUtil", "8.2.0.749")]
	public enum dir_pollingstationState
	{
	...
	/// </summary>
	[System.Runtime.Serialization.DataContractAttribute()]
	[Microsoft.Xrm.Sdk.Client.EntityLogicalNameAttribute("dir_pollingstation")]
	[System.CodeDom.Compiler.GeneratedCodeAttribute("CrmSvcUtil", "8.2.0.749")]
	public partial class dir_pollingstation : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		
		/// <summary>
		/// Default Constructor.
		/// </summary>
		public dir_pollingstation() : 
				base(EntityLogicalName)
		{
		}
		
		public const string EntityLogicalName = "dir_pollingstation";
		...
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("dir_name")]
		public string dir_name
		{
			get
			{
				return this.GetAttributeValue<string>("dir_name");
			}
			set
			{
				this.OnPropertyChanging("dir_name");
				this.SetAttributeValue("dir_name", value);
				this.OnPropertyChanged("dir_name");
			}
		}
		...
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("dir_pollingstationid")]
		public System.Nullable<System.Guid> dir_pollingstationId
		{
			get
			{
				return this.GetAttributeValue<System.Nullable<System.Guid>>("dir_pollingstationid");
			}
			set
			{
				this.OnPropertyChanging("dir_pollingstationId");
				this.SetAttributeValue("dir_pollingstationid", value);
				if (value.HasValue)
				{
					base.Id = value.Value;
				}
				...
				this.OnPropertyChanged("dir_pollingstationId");
			}
		}
		...
		public override System.Guid Id
		{
			...
			set
			{
				this.dir_pollingstationId = value;
			}
		}
		...
		/// <summary>
		/// Status of the Polling Station
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("statecode")]
		public System.Nullable<TypedEntities.dir_pollingstationState> statecode
		{
			get
			{
				Microsoft.Xrm.Sdk.OptionSetValue optionSet = this.GetAttributeValue<Microsoft.Xrm.Sdk.OptionSetValue>("statecode");
				if ((optionSet != null))
				{
					return ((TypedEntities.dir_pollingstationState)(System.Enum.ToObject(typeof(TypedEntities.dir_pollingstationState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		/// <summary>
		/// Reason for the status of the Polling Station
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("statuscode")]
		public Microsoft.Xrm.Sdk.OptionSetValue statuscode
		{
		...
		/// <summary>
		/// 1:N dir_dir_pollingstation_dir_vote
		/// </summary>
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("dir_dir_pollingstation_dir_vote")]
		public System.Collections.Generic.IEnumerable<TypedEntities.dir_vote> dir_dir_pollingstation_dir_vote
		{
			get
			{
				return this.GetRelatedEntities<TypedEntities.dir_vote>("dir_dir_pollingstation_dir_vote", null);
			}
			set
			{
				this.OnPropertyChanging("dir_dir_pollingstation_dir_vote");
				this.SetRelatedEntities<TypedEntities.dir_vote>("dir_dir_pollingstation_dir_vote", null, value);
				this.OnPropertyChanged("dir_dir_pollingstation_dir_vote");
			}
		}
	}
	...
	/// </summary>
	[System.Runtime.Serialization.DataContractAttribute()]
	[Microsoft.Xrm.Sdk.Client.EntityLogicalNameAttribute("dir_vote")]
	[System.CodeDom.Compiler.GeneratedCodeAttribute("CrmSvcUtil", "8.2.0.749")]
	public partial class dir_vote : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public const string EntityLogicalName = "dir_vote";
		...
		/// Person who voted
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("dir_contactid")]
		public Microsoft.Xrm.Sdk.EntityReference dir_contactid
		{
			get
			{
				return this.GetAttributeValue<Microsoft.Xrm.Sdk.EntityReference>("dir_contactid");
			}
			set
			{
				this.OnPropertyChanging("dir_contactid");
				this.SetAttributeValue("dir_contactid", value);
				this.OnPropertyChanged("dir_contactid");
			}
		}
		...
		/// <summary>
		/// Polling station where the person voted
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("dir_pollingstationid")]
		public Microsoft.Xrm.Sdk.EntityReference dir_pollingstationid
		{
			get
			{
				return this.GetAttributeValue<Microsoft.Xrm.Sdk.EntityReference>("dir_pollingstationid");
			}
			set
			{
				this.OnPropertyChanging("dir_pollingstationid");
		...
		/// 
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("dir_votedate")]
		public System.Nullable<System.DateTime> dir_votedate
		{
			get
			{
				return this.GetAttributeValue<System.Nullable<System.DateTime>>("dir_votedate");
			}
			set
			{
				this.OnPropertyChanging("dir_votedate");
				this.SetAttributeValue("dir_votedate", value);
				this.OnPropertyChanged("dir_votedate");
			}
		}
		...
		/// Unique identifier for entity instances
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("dir_voteid")]
		public System.Nullable<System.Guid> dir_voteId
		{
			get
			{
				return this.GetAttributeValue<System.Nullable<System.Guid>>("dir_voteid");
			}
			set
			{
				this.OnPropertyChanging("dir_voteId");
				this.SetAttributeValue("dir_voteid", value);
				if (value.HasValue)
				{
					base.Id = value.Value;
				}
				...
				this.OnPropertyChanged("dir_voteId");
			}
		}
		...
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("statecode")]
		public System.Nullable<TypedEntities.dir_voteState> statecode
		{
			get
			{
				Microsoft.Xrm.Sdk.OptionSetValue optionSet = this.GetAttributeValue<Microsoft.Xrm.Sdk.OptionSetValue>("statecode");
				if ((optionSet != null))
				{
					return ((TypedEntities.dir_voteState)(System.Enum.ToObject(typeof(TypedEntities.dir_voteState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		/// <summary>
		/// Reason for the status of the Vote
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("statuscode")]
		public Microsoft.Xrm.Sdk.OptionSetValue statuscode
		{
		...
		/// <summary>
		/// N:1 dir_contact_dir_vote
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("dir_contactid")]
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("dir_contact_dir_vote")]
		public TypedEntities.Contact dir_contact_dir_vote
		{
			get
			{
				return this.GetRelatedEntity<TypedEntities.Contact>("dir_contact_dir_vote", null);
			}
			set
			{
				this.OnPropertyChanging("dir_contact_dir_vote");
				this.SetRelatedEntity<TypedEntities.Contact>("dir_contact_dir_vote", null, value);
				this.OnPropertyChanged("dir_contact_dir_vote");
			}
		}
		
		/// <summary>
		/// N:1 dir_dir_pollingstation_dir_vote
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("dir_pollingstationid")]
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("dir_dir_pollingstation_dir_vote")]
		public TypedEntities.dir_pollingstation dir_dir_pollingstation_dir_vote
		{
			get
			{
				return this.GetRelatedEntity<TypedEntities.dir_pollingstation>("dir_dir_pollingstation_dir_vote", null);
			}
			set
			{
				this.OnPropertyChanging("dir_dir_pollingstation_dir_vote");
				this.SetRelatedEntity<TypedEntities.dir_pollingstation>("dir_dir_pollingstation_dir_vote", null, value);
				this.OnPropertyChanged("dir_dir_pollingstation_dir_vote");
			}
		}
	}
	...
	public partial class XrmServiceContext : Microsoft.Xrm.Sdk.Client.OrganizationServiceContext
	{
		...
		/// <summary>
		/// Gets a binding to the set of all <see cref="TypedEntities.Contact"/> entities.
		/// </summary>
		public System.Linq.IQueryable<TypedEntities.Contact> ContactSet
		{
			get
			{
				return this.CreateQuery<TypedEntities.Contact>();
			}
		}
		
		/// <summary>
		/// Gets a binding to the set of all <see cref="TypedEntities.dir_pollingstation"/> entities.
		/// </summary>
		public System.Linq.IQueryable<TypedEntities.dir_pollingstation> dir_pollingstationSet
		{
			get
			{
				return this.CreateQuery<TypedEntities.dir_pollingstation>();
			}
		}
		
		/// <summary>
		/// Gets a binding to the set of all <see cref="TypedEntities.dir_vote"/> entities.
		/// </summary>
		public System.Linq.IQueryable<TypedEntities.dir_vote> dir_voteSet
		{
			get
			{
				return this.CreateQuery<TypedEntities.dir_vote>();
			}
		}
	}
}
