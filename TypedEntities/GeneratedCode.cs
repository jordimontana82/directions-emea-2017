...
public partial class Contact : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
{
	...
	public System.Collections.Generic.IEnumerable<dir_vote> dir_contact_dir_vote
	{
		get
		{
			return this.GetRelatedEntities<dir_vote>("dir_contact_dir_vote", null);
		}
		set
		{
			this.OnPropertyChanging("dir_contact_dir_vote");
			this.SetRelatedEntities<dir_vote>("dir_contact_dir_vote", null, value);
...
public partial class dir_pollingstation : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
{
	...
	/// </summary>
	[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("statecode")]
	public System.Nullable<dir_pollingstationState> statecode
	{
		get
		{
			Microsoft.Xrm.Sdk.OptionSetValue optionSet = this.GetAttributeValue<Microsoft.Xrm.Sdk.OptionSetValue>("statecode");
			if ((optionSet != null))
			{
				return ((dir_pollingstationState)(System.Enum.ToObject(typeof(dir_pollingstationState), optionSet.Value)));
			}
			else
			{
				return null;
	...
	public System.Collections.Generic.IEnumerable<dir_vote> dir_dir_pollingstation_dir_vote
	{
		get
		{
			return this.GetRelatedEntities<dir_vote>("dir_dir_pollingstation_dir_vote", null);
		}
		set
		{
			this.OnPropertyChanging("dir_dir_pollingstation_dir_vote");
			this.SetRelatedEntities<dir_vote>("dir_dir_pollingstation_dir_vote", null, value);
...
public partial class dir_vote : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
{
	...
	/// </summary>
	[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("statecode")]
	public System.Nullable<dir_voteState> statecode
	{
		get
		{
			Microsoft.Xrm.Sdk.OptionSetValue optionSet = this.GetAttributeValue<Microsoft.Xrm.Sdk.OptionSetValue>("statecode");
			if ((optionSet != null))
			{
				return ((dir_voteState)(System.Enum.ToObject(typeof(dir_voteState), optionSet.Value)));
			}
			else
			{
				return null;
	...
	[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("dir_contactid")]
	[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("dir_contact_dir_vote")]
	public Contact dir_contact_dir_vote
	{
		get
		{
			return this.GetRelatedEntity<Contact>("dir_contact_dir_vote", null);
		}
		set
		{
			this.OnPropertyChanging("dir_contact_dir_vote");
			this.SetRelatedEntity<Contact>("dir_contact_dir_vote", null, value);
			this.OnPropertyChanged("dir_contact_dir_vote");
		}
	}
	...
	[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("dir_pollingstationid")]
	[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("dir_dir_pollingstation_dir_vote")]
	public dir_pollingstation dir_dir_pollingstation_dir_vote
	{
		get
		{
			return this.GetRelatedEntity<dir_pollingstation>("dir_dir_pollingstation_dir_vote", null);
		}
		set
		{
			this.OnPropertyChanging("dir_dir_pollingstation_dir_vote");
			this.SetRelatedEntity<dir_pollingstation>("dir_dir_pollingstation_dir_vote", null, value);
			this.OnPropertyChanged("dir_dir_pollingstation_dir_vote");
		}
	}
}
